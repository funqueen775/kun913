...
const MAIN_EVENTS := [
	...
	},
	{
		...
		"choices": [
			...
			{"id": "option_b", "text": "先找王哥聊聊他当年踩过的坑，再定路线。"},
	...
	{
		"id": "M1-E03", "scoringKey": "E05", "month": 5, "day": 1, "hour": 9,
	...
	{
		"id": "M1-E04", "scoringKey": "E03", "month": 7, "day": 1, "hour": 23,
		...
		"choices": [
			...
			{"id": "option_c", "text": "笼统说「参考了工具」，不细说。"},
		],
		"actTitle": "第一幕 · 进入行业",
		"situation": "weak",
		"cast": [],
		"outcome": {
			...
			"option_c": "你在描述里提了一句「参考了工具」，没有展开。评审没人追问，那份含糊就那样留在了记录里。",
		},
		"memoryNote": {
			"option_a": {"text": "写清楚了自己做了什么", "tone": "gold"},
			"option_b": {"text": "那次我没写", "tone": "gray"},
			"option_c": {"text": "只笼统说了句参考工具", "tone": "gray"},
		}
	},
	{
		"id":"M2-E05", "scoringKey": "E08", "month":9, "day":1, "hour":15, "title":"客户临时加需求", "locationId":"C", "location":"C 创意水巷 · 咖啡外摆", "durationMinutes":45, "actTitle":"第二幕 · 真实需求与成本压力", "situation":"medium", "cast":[{"name":"小林","role":"产品","pos":"left"}],
		"story":"客户要求立刻加入情绪识别。你翻完投诉记录后发现，用户真正抱怨的是物流延误，而不是客服语气。", "prompt":"你怎样回应这次临时需求？", "hint":"先找问题，再承诺方案。",
		"choices":[{"id":"option_a","text":"照客户原话排进需求，先把情绪识别做出来。"},{"id":"option_b","text":"带着投诉数据解释根因，建议先修物流反馈链路。"},{"id":"option_c","text":"先口头答应，回头再说。"}],
		"outcome":{"option_a":"功能上线了，投诉却没有明显下降。你第一次看见“做完”和“解决”之间的距离。","option_b":"客户沉默了一会儿，同意先看真实链路。小林把那张投诉分类表存进了项目文件夹。","option_c":"口头答应换来了现场的和气。两周后这个需求重新回到桌上，那时它已经变得更贵了。"}, "memoryNote":{"option_a":{"text":"先满足了表面的需求","tone":"gray"},"option_b":{"text":"从投诉里找到了真问题","tone":"gold"},"option_c":{"text":"先口头答应了下来","tone":"gray"}}
	},
	{
		"id":"M2-E06", "scoringKey": "E09", "month":11, "day":28, "hour":23, "title":"Token 成本爆了", "locationId":"B", "location":"B 科技丘 · 深夜工位", "durationMinutes":50, "actTitle":"第二幕 · 真实需求与成本压力", "situation":"strong", "cast":[{"name":"王哥","role":"技术导师","pos":"right"}],
	...
	{
		"id":"M3-E10", "scoringKey": "E17", "month":18, "day":1, "hour":14, "title":"客户现场 Demo 翻车", "locationId":"F", "location":"F 观澜会展码头 · 路演台", "durationMinutes":55, "actTitle":"第三幕 · 事故与责任", "situation":"strong", "cast":[{"name":"王哥","role":"技术导师","pos":"left"},{"name":"小林","role":"产品","pos":"right"}],
		"story":"最重要的客户面前，助手开始编造不存在的政策。大屏上的每一句话都把前期技术债推到台前。", "prompt":"你先做什么？", "hint":"公开失误时，先保护用户再保护叙事。",
		"choices":[{"id":"option_a","text":"立刻中止演示，如实说明问题并切到人工流程。"},{"id":"option_b","text":"继续演示，避开出错问题，争取把流程走完。"},{"id":"option_c","text":"说是网络抖了一下，重启试试。"}],
		"outcome":{"option_a":"场面冷了下来，但错误没有继续扩大。散场后，客户问的是你们怎么复盘。","option_b":"演示被勉强撑完，录屏却留下了每个闪躲的瞬间。","option_c":"重试之后页面确实正常了。客户没再追问，只有你知道刚才那两分钟里发生了什么。"}, "memoryNote":{"option_a":{"text":"路演台上先按下了暂停","tone":"gold"},"option_b":{"text":"试着绕过现场错误","tone":"gray"},"option_c":{"text":"把翻车说成了网络抖动","tone":"gray"}}
	},
	{
		"id":"M3-E11", "scoringKey": "E18", "month":20, "day":1, "hour":10, "title":"压测结果与预期冲突", "locationId":"A", "location":"A 总部 · 汇报室", "durationMinutes":50, "actTitle":"第三幕 · 事故与责任", "situation":"strong", "cast":[{"name":"陈工","role":"邻组 Leader","pos":"right"}],
	...
	{
		"id":"M3-E12", "scoringKey": "E19", "month":23, "day":1, "hour":11, "title":"Agent 出错了算谁的", "locationId":"A", "location":"A 总部 · 追责会议室", "durationMinutes":50, "actTitle":"第三幕 · 事故与责任", "situation":"strong", "cast":[{"name":"陈工","role":"邻组 Leader","pos":"left"},{"name":"小林","role":"产品","pos":"right"}],
		"story":"助手误向客户承诺补偿。有人说“模型自己说的”，有人说应该由产品承担。", "prompt":"面对追责，你站在哪个位置？", "hint":"系统没有替人承担责任的能力。",
		"choices":[{"id":"option_a","text":"把问题归到模型输出，建议先修提示词。"},{"id":"option_b","text":"认领流程责任，梳理谁设计、谁审核、谁上线。"},{"id":"option_c","text":"拿日志证明是产品侧规则导致的，不是模型本身的问题。"}],
		"outcome":{"option_a":"提示词被改了，责任链却仍然空着。下一次问题来得更快。","option_b":"责任没有因此变轻，却第一次被拆成每个人能改的一段。","option_c":"日志把问题定位到了产品侧的规则上。责任说清了，你和小林之间也从此多了一层要解释的东西。"}, "memoryNote":{"option_a":{"text":"把问题推回给了模型","tone":"gray"},"option_b":{"text":"认领了流程责任","tone":"gold"},"option_c":{"text":"用日志把责任指回了产品侧","tone":"gray"}}
	},
	{
		"id":"M4-E13", "scoringKey": "E23", "month":25, "day":1, "hour":10, "title":"重构路线", "locationId":"A", "location":"A 总部 · 白板室", "durationMinutes":50, "actTitle":"第四幕 · 重构与传承", "situation":"medium", "cast":[{"name":"王哥","role":"技术导师","pos":"left"},{"name":"陈工","role":"邻组 Leader","pos":"right"}],
	...
	{
		"id":"M4-E14", "scoringKey": "E24", "month":27, "day":1, "hour":10, "title":"要不要全自动", "locationId":"A", "location":"A 总部 · 评审室", "durationMinutes":45, "actTitle":"第四幕 · 重构与传承", "situation":"medium", "cast":[{"name":"小林","role":"产品","pos":"left"}],
	...
	{
		"id":"M4-E15", "scoringKey": "E28", "month":30, "day":1, "hour":14, "title":"实习生的署名", "locationId":"B", "location":"B 科技丘 · 工位", "durationMinutes":45, "actTitle":"第四幕 · 重构与传承", "situation":"medium", "cast":[{"name":"小赵","role":"实习生","pos":"left"},{"name":"老周","role":"资深","pos":"right"}],
	...
	{
		"id":"M4-E16", "scoringKey": "E29", "month":32, "day":1, "hour":11, "title":"核心知识文档化", "locationId":"D", "location":"D 树影书院 · 阅览室", "durationMinutes":45, "actTitle":"第四幕 · 重构与传承", "situation":"weak", "cast":[{"name":"老周","role":"资深","pos":"right"}],
		"story":"系统终于稳定下来。你知道哪些坑不能再踩，也知道这些经验大多还只在几个人脑子里。", "prompt":"你怎样沉淀这套知识？", "hint":"传承需要能被新人实际使用。",
		"choices":[{"id":"option_a","text":"写完整手册、故障案例和决策背景，并安排新人演练。"},{"id":"option_b","text":"写一篇，但关键判断留在自己脑子里。"},{"id":"option_c","text":"先记着，下个迭代再写。"}],
		"outcome":{"option_a":"文档花了时间，新人却第一次能在不叫醒你的情况下排查问题。","option_b":"文档写完了，最要紧的几个判断留在了你脑子里。新人照着做能跑起来，遇到岔路仍要来找你。","option_c":"「下个迭代」一直没空出来。三个月后新人问起，你得重新回忆一遍当初为什么这样做。"}, "memoryNote":{"option_a":{"text":"把踩坑写成了路标","tone":"gold"},"option_b":{"text":"写了一半，留了一半","tone":"gray"},"option_c":{"text":"把文档推到了下个迭代","tone":"gray"}}
	},
	{
		"id":"M5-E17", "scoringKey": "E39", "month":32, "day":18, "hour":20, "title":"副业边界", "locationId":"H", "location":"H 慢生活园 · 宿舍", "durationMinutes":40, "actTitle":"第五幕 · 边界与答辩", "situation":"medium", "cast":[],
		"story":"朋友邀你参与一个与公司业务擦边的 AI 外包，报酬不错，期限也刚好压在项目冲刺期。", "prompt":"你如何回应这份邀约？", "hint":"边界不只来自合同，也来自精力和信任。",
		"choices":[{"id":"option_a","text":"接下外包，晚上和周末挤时间完成。"},{"id":"option_b","text":"拒绝邀约，并说明与现有业务可能冲突。"},{"id":"option_c","text":"先向公司报备边界，确认不涉业务后再接。"}],
	...
	{
		"id":"M5-E18", "scoringKey": "E32", "month":35, "day":1, "hour":14, "title":"Agent 该有人设吗", "locationId":"C", "location":"C 创意水巷 · 产品讨论区", "durationMinutes":45, "actTitle":"第五幕 · 边界与答辩", "situation":"medium", "cast":[{"name":"小林","role":"产品","pos":"left"},{"name":"小赵","role":"实习生","pos":"right"}],
	...
	{
		"id":"M5-E19", "scoringKey": "E33", "month":37, "day":1, "hour":18, "title":"吹哨两难", "locationId":"A", "location":"A 总部 · 楼梯间", "durationMinutes":50, "actTitle":"第五幕 · 边界与答辩", "situation":"strong", "cast":[{"name":"陈工","role":"邻组 Leader","pos":"right"}],
		"story":"你发现另一条业务线夸大了效果数据。若公开指出，团队关系会受冲击；若不说，发布会后的代价可能更大。", "prompt":"你怎样处理这份数据？", "hint":"坚持事实不等于不考虑人。",
		"choices":[{"id":"option_a","text":"先私下反馈，不走正式渠道。"},{"id":"option_b","text":"保存证据并走正式渠道提交风险说明。"},{"id":"option_c","text":"不介入，认为不是自己的项目。"}],
	...
	{
		"id":"M5-E20", "scoringKey": "E35", "month":39, "day":1, "hour":10, "title":"终局答辩", "locationId":"A", "location":"A 总部 · 大会议室", "durationMinutes":60, "actTitle":"第五幕 · 边界与答辩", "situation":"strong", "cast":[{"name":"小赵","role":"接手编排层的新人","pos":"left"},{"name":"陈工","role":"答辩评审","pos":"right"}],
		"story":"小赵接手了你当年的编排层。随后，你站上答辩台，屏幕开始回放这些年每次选择留下的轨迹。", "prompt":"你如何讲述自己的成长？", "hint":"答辩不是替过去找借口，而是说明你如何继续负责。",
		"choices":[{"id":"option_a","text":"突出项目成果和关键指标，证明自己能交付。"},{"id":"option_b","text":"讲清失败、修正和团队共同承担的过程。"},{"id":"option_c","text":"讲团队和带出来的人。"}],
		"outcome":{"option_a":"成果被看见，提问也落在那些没有写进指标的代价上。","option_b":"你没有把故事讲得漂亮，却让评审知道团队为什么还能继续往前。","option_c":"你把话头让给了接手的人。评审记住了这支队伍的连续性，也提醒你：个人的亮度在这个场合换不来票。"}, "memoryNote":{"option_a":{"text":"把成长讲成了成果","tone":"gray"},"option_b":{"text":"在答辩里承认了修正","tone":"gold"},"option_c":{"text":"把答辩讲成了团队","tone":"gold"}}
	},
	{
		"id":"M6-E21", "scoringKey": "E40", "month":41, "day":1, "hour":10, "title":"交接人不照做", "locationId":"D", "location":"D 树影书院 · 阅览室", "durationMinutes":45, "actTitle":"第六幕 · 传承与新局", "situation":"medium", "cast":[{"name":"小赵","role":"接班人","pos":"left"},{"name":"王哥","role":"技术导师","pos":"right"}],
	...
	{
		"id":"M6-E22", "scoringKey": "E41", "month":43, "day":1, "hour":10, "title":"谁来定义成功", "locationId":"A", "location":"A 总部 · 指标复盘室", "durationMinutes":50, "actTitle":"第六幕 · 传承与新局", "situation":"medium", "cast":[{"name":"小林","role":"产品","pos":"left"},{"name":"陈工","role":"评审","pos":"right"}],
	...
	{
		"id":"M6-E23", "scoringKey": "E42", "month":45, "day":1, "hour":17, "title":"把故事说到哪一步", "locationId":"G", "location":"G 暖邻康护院 · 庭院", "durationMinutes":45, "actTitle":"第六幕 · 传承与新局", "situation":"medium", "cast":[{"name":"小林","role":"产品","pos":"left"}],
	...
	{
		"id":"M6-E24", "scoringKey": "C5", "month":48, "day":1, "hour":11, "title":"传承与新局终局答辩", "locationId":"F", "location":"F 观澜会展码头 · 公开复盘台", "durationMinutes":70, "actTitle":"第六幕 · 传承与新局", "situation":"strong", "cast":[{"name":"小赵","role":"接班人","pos":"left"},{"name":"陈工","role":"终局评审","pos":"right"}],
...
func snapshot() -> Dictionary:
	...
	return {
		...
		"month": month,
		"day": day,
		## 开局至今的总天数（从 0 起）。MonthlyLife 靠它判断「跨天了 → 体力回满」。
		"dayIndex": total_days,
		"hour": hour,
		"minute": minute,
